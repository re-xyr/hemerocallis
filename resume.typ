...
#set page(paper: "us-letter", margin: (x: .5in, y: .5in))
...
#let project(
  ...
  #entry-heading(split(strong(name), emph(if url != none { linkurl(url) } else {
    text("(WIP)", luma(100))
  })))
  #body
]
...
#experience([Google], (
  ...
  - (2025) Data pipeline development for Hotel Ads in Google Search #text([⟨more information pending NDA release⟩], luma(100))
  - (2024) Implemented a new feature in the Google Search math solver and launched a live experiment
  - Engaged extensively with the Google Search and Ads technology stacks
]
...
#project([Aqn], "https://github.com/re-xyr/aqn")[
  - Efficient dependent type elaboration algorithm in Haskell by #link("https://en.wikipedia.org/wiki/Normalisation_by_evaluation")[normalization-by-evaluation] and pattern unification
]

#project([Inkclip], "https://github.com/project-daylily/inkclip")[
...
#section-title[Skills]
  ...
  - *Technologies:* Functional Programming, Compiler frontend, Type systems, Full-stack web development
